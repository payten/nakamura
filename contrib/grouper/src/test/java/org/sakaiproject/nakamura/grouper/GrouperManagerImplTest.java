...
public class GrouperManagerImplTest extends TestCase {
	...
	public void testGetInstitutionalGroupName(){
		String grouperName = "apps:sakaioae:courses:some:course:lecturers";
		assertEquals("inst:sis:courses:some:course:instructors", grouperManager.getInstitutionalGroupName(grouperName));
	}
}
