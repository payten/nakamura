...
@Properties(value = {
    ...
    @Property(name = AuthenticationHandler.TYPE_PROPERTY, value = RestAuthenticationHandler.AUTH_TYPE, propertyPrivate = true),
    @Property(name = RestAuthenticationHandler.REST_AUTOCREATE_USER, boolValue = RestAuthenticationHandler.DEFAULT_REST_AUTOCREATE_USER),
    @Property(name = RestAuthenticationHandler.LOGIN_URL, value = RestAuthenticationHandler.DEFAULT_LOGIN_URL),
    @Property(name = RestAuthenticationHandler.LOGOUT_URL, value = RestAuthenticationHandler.DEFAULT_LOGOUT_URL),
    @Property(name = RestAuthenticationHandler.SERVER_URL, value = RestAuthenticationHandler.DEFAULT_SERVER_URL),
    @Property(name = RestAuthenticationHandler.ATTRIBUTES_NAMES, value = RestAuthenticationHandler.DEFAULT_ATTRIBUTE_NAME),
    @Property(name = RestAuthenticationHandler.MISSING_LOCAL_USER_URL, value = RestAuthenticationHandler.DEFAULT_MISSING_LOCAL_USER_URL)
})
public class RestAuthenticationHandler implements AuthenticationHandler,
    AuthenticationFeedbackHandler {

  public static final String AUTH_TYPE = "REST";

  private static final Logger LOGGER = LoggerFactory
      .getLogger(RestAuthenticationHandler.class);
  ...
  static final String REST_AUTOCREATE_USER = "sakai.auth.rest.user.autocreate";

  static final String AUTHN_INFO = "org.sakaiproject.nakamura.auth.rest.RestAuthnInfo";
  public static final boolean DEFAULT_REST_AUTOCREATE_USER = false;
  ...
  static final String LOGIN_URL = "sakai.auth.rest.url.login";
  private String loginUrl;

  static final String LOGOUT_URL = "sakai.auth.rest.url.logout";
  private String logoutUrl;

  static final String SERVER_URL = "sakai.auth.rest.url.server";
  private String serverUrl;

  static final String ATTRIBUTES_NAMES = "sakai.auth.rest.user.attribute";
  private String attributeName;

  static final String MISSING_LOCAL_USER_URL = "sakai.auth.rest.user.missing";
  ...
  RestAuthenticationHandler(Repository repository,
...
//    }
  ...
  private AuthenticationInfo createAuthnInfo(final String username) {
    final RestPrincipal principal = new RestPrincipal(username);
    ...
    SimpleCredentials credentials = new SimpleCredentials(principal.getName(),
        new char[] {});
    credentials.setAttribute(RestPrincipal.class.getName(), principal);
  ...
  protected String constructServiceParameter(HttpServletRequest request)
    ...
    String tryLogin = RestLoginServlet.TRY_LOGIN + "=2";
  ...
  static final class RestPrincipal implements Principal {
    private static final long serialVersionUID = -6232157660434175773L;
    private String principalName;

    public RestPrincipal(String principalName) {
